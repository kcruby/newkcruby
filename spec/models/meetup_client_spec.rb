    ...
    [
      ...
      describe "multiple examples" do
        ...
        it "should return the calendar data" do
          ...
          stub_request(:get, "http://api.meetup.com/2/events?fields=&format=json&group_urlname=kcruby&key=#{ENV['MEETUP_API_KEY']}&limited_events=False&order=time&page=20&sign=true&status=upcoming").
        ...
        it "should return the member data" do
          ...
          stub_request(:get, "http://api.meetup.com/2/groups?desc=false&fields=&format=json&group_id=575011&key=#{ENV['MEETUP_API_KEY']}&offset=0&order=id&page=500&photo-host=public&radius=25.0&sign=true").
             with(:headers => {'Accept'=>'*/*', 'User-Agent'=>'Ruby'}).
             to_return(:status => 200, :body => example.to_json, :headers => {})
